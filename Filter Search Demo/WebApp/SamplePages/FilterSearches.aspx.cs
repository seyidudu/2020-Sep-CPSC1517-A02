...
namespace WebApp.NorthwindPages
{
    public partial class FilterSearches : System.Web.UI.Page
    {
        ...
        {
            // checking if you are on the prompt line(if presen) of the droopdownlist
            //      is the ONE PLSCE I will use the .SelectedIndex
        ...
        //{
          //  if(SupplierList.SelectedIndex==0)
          //  {
          //      errormsgs.Add("Select a supplier to view the categories.");
          //      LoadMessageDisplay(errormsgs, "alert alert-info");
         ...
         //       ProductsGridViewV5.DataSource = null;
          ...
          //  {
           //     try
            //    {
                   // CategoryController sysmgr = new CategoryController();
                    //List<Category> info = sysmgr.SupplierCategories(int.Parse(SupplierList.SelectedValue));
               // }
              //  catch (Exception ex)
             //   {
              //      errormsgs.Add(GetInnerException(ex).ToString());
