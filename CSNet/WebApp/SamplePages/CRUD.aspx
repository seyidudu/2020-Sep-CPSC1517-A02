...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:CompareValidator ID="CompareUnitPrice" runat="server" 
        ...
        Display="Dynamic" SetFocusOnError="true" ControlToValidate="UnitPrice" 
        Type="Double" Operator="GreaterThanEqual" ValueToCompare="0.00">
    </asp:CompareValidator>
     <asp:CompareValidator ID="CompareUnitInStock" runat="server" 
        ErrorMessage="Quantity on Hand must be amount 0 or greater"
        Display="Dynamic" SetFocusOnError="true" ControlToValidate="UnitInStock" 
        Type="Integer" Operator="GreaterThanEqual" ValueToCompare="0">
    </asp:CompareValidator>
     <asp:CompareValidator ID="CompareUnitOnOrder" runat="server" 
        ErrorMessage="Units on Order must be amount 0 or greater"
        Display="Dynamic" SetFocusOnError="true" ControlToValidate="UnitOnOrder" 
        Type="Integer" Operator="GreaterThanEqual" ValueToCompare="0">
    </asp:CompareValidator>
    <asp:CompareValidator ID="CompareReorderLevel" runat="server" 
        ErrorMessage="Reorder Level must be amount 0 or greater"
        Display="Dynamic" SetFocusOnError="true" ControlToValidate="ReorderLevel" 
        Type="Integer" Operator="GreaterThanEqual" ValueToCompare="0">
    </asp:CompareValidator>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <table>
                ...
                <tr>
                    <td align="right">
                        <asp:Label ID="Label8" runat="server" Text="QoO></asp:Label>
                    </td>
                    <td align="left">
